...
export default function CheckoutPixModal({ pagamento, isOpen, onClose, onSuccess }: CheckoutPixModalProps) {
  ...
  const pixCode = pagamento?.codigoPix || "00020101021226830014br.gov.bcb.pix2561pix-qr.mercadopago.com/instants/638a1b2c-3d4e-5f6g-7h8i-9j0k1l2m3n4o5204000053039865802BR5925MANUS FREELANCER6009SAO PAULO62070503***6304ABCD";
          ...
          <div className="w-full space-y-3">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 p-3 rounded-lg flex gap-3">
              ...
              <p className="text-[10px] text-blue-800 dark:text-blue-300 leading-relaxed">
                Esta é uma simulação de integração com o Mercado Pago. Em um ambiente real, o status seria atualizado automaticamente via Webhook.
              </p>
            </div>
          </div>
        </div>
